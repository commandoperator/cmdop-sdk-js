...
import { WorkspacesWorkspaces } from "./workspaces__api__workspaces/client";
export * as WorkspacesWorkspacesTypes from "./workspaces__api__workspaces/models";
...
export class API {
  ...
  constructor(baseUrl: string, options?: APIOptions) {
    ...
    this.workspaces_workspaces = this._client.workspaces_workspaces;
  }
