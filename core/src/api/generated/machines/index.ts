...
import { MachinesMachineSharing } from "./machines__api__machine_sharing/client";
import { MachinesMachines } from "./machines__api__machines/client";
export * as MachinesMachineSharingTypes from "./machines__api__machine_sharing/models";
...
export * as MachinesMachinesTypes from "./machines__api__machines/models";
// Note: Direct exports (export * from) are removed to avoid duplicate type conflicts
// Use namespace exports like CfgAccountsTypes.User or import from specific modules
...
export class API {
  ...
  constructor(baseUrl: string, options?: APIOptions) {
    ...
    this.machines_machine_sharing = this._client.machines_machine_sharing;
    this.machines_machines = this._client.machines_machines;
  }
