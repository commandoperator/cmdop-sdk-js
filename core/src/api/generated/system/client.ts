import { SystemOauth } from "./system__api__oauth";
import { SystemSystem } from "./system__api__system";
...
export class APIClient {
  ...
  // Sub-clients
  public system_oauth: SystemOauth;
  public system_system: SystemSystem;
  ...
  constructor(
    ...
    this.system_oauth = new SystemOauth(this);
    this.system_system = new SystemSystem(this);
  }
