...
import { SystemOauth } from "./system__api__oauth/client";
import { SystemSystem } from "./system__api__system/client";
export * as SystemOauthTypes from "./system__api__oauth/models";
...
export * as SystemSystemTypes from "./system__api__system/models";
// Note: Direct exports (export * from) are removed to avoid duplicate type conflicts
// Use namespace exports like CfgAccountsTypes.User or import from specific modules
...
export class API {
  ...
  constructor(baseUrl: string, options?: APIOptions) {
    ...
    this.system_oauth = this._client.system_oauth;
    this.system_system = this._client.system_system;
  }
